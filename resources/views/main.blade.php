...
@section('content')
    <!-- component -->
    <section class="flex items-center flex-col  h-full"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-12 h-screen ">
            @forelse ($events as $event)
                <div
                    ...
                    <div class="px-5 pb-5">
                        <a href="#">
                            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ $event->title }}</h5>
                        </a>
